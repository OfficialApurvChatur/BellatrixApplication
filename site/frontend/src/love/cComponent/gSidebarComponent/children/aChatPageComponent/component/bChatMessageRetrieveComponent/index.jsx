    ...
    <>
      <Card 
        className={`
          ...
          bg-[#FAEBEF] dark:bg-[#333D79]
          border-[#333D79] dark:border-[#FAEBEF]
          text-[#333D79] dark:text-[#FAEBEF]`}
      >
        <CardHeader className="flex flex-row items-center justify-between py-2 border-b border-[#333D79] dark:border-[#FAEBEF]">
        ...
        <CardFooter className="py-2 border-y border-[#333D79] dark:border-[#FAEBEF] bottom-0">
          <form className="flex w-full items-center space-x-2">
            <Input
              id="message"
              placeholder="Type your message..."
              className="flex-1 border-[#333D79] dark:border-[#FAEBEF]"
              autoComplete="off"
              value={input}
