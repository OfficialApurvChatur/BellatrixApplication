              ...
              return (
                <React.Fragment key={index}>
                  <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
                    <div className="bg-[#333D79] dark:bg-[#FAEBEF] text-[#FAEBEF] dark:text-[#333D79] bg-opacity-60 px-4 py-6 rounded-lg">
                      {
                        each.title === "Frontend Application Deployed" ? (
                          <div className="w-12 h-12 mb-3 inline-flex items-center justify-center rounded-full bg-[#FAEBEF] dark:bg-[#333D79] text-[#333D79] dark:text-[#FAEBEF] flex-shrink-0">
